...
namespace umfgcloud.infraestrutura.service.Maps
{
    internal abstract class AbstractEntityMap<T> : IEntityTypeConfiguration<T> where T : AbstractEntity
    {
        public virtual void Configure(EntityTypeBuilder<T> builder)
        {
            ...
            builder.Property(x => x.CreateAt).HasColumnName("DT_CREATE");
            builder.Property(x => x.UpdateAt).HasColumnName("DT_UPDATE");
            builder.Property(x => x.CreatedByUserId).HasColumnName("ID_USER_CREEATE");
            builder.Property(x => x.UpdateByUserId).HasColumnName("ID_USER_UPDATE");
            builder.Property(x => x.CreatedByUserEmail).HasColumnName("DS_USER_EMAIL_CREATE");
            builder.Property(x => x.UpdateByUserEmail).HasColumnName("DS_USER_EMAIL_UPDATE");
