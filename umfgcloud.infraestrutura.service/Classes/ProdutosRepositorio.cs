...
{
    public class ProdutosRepositorio : AbstractRepositorio<ProdutoEntity>, IProdutoRepositorio
    {
        public ProdutosRepositorio(MySqlDataBaseContext context) : base(context)
        {
        }
    }
}
